...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 97064eb4-ee98-47e1-b18d-ffeb59a489dd
```

> `97064eb4-ee98-47e1-b18d-ffeb59a489dd` is the password of the certificate, you can change it to any password you want.
